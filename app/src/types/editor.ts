...
export interface EditorState {
  jobId: string;
  jobName: string;
  watermark?: boolean;             // Server-computed watermark decision for exports (never store raw email client-side)
  clips: TimelineClip[];
...
export type EditorAction =
  | { type: 'INIT'; payload: { jobId: string; jobName: string; clips: TimelineClip[]; watermark?: boolean } }
